...
```
bash <(curl -s https://raw.githubusercontent.com/mrvexyplays/Mega-VM/main/install.sh)
```
OR

```
bash <(wget -qO- https://raw.githubusercontent.com/mrvexyplays/Mega-VM/main/install.sh)
```
Join Our Discord Server to get Activation Key : https://discord.gg/feelings

*Paid Version Also Available!*


# Made By theaditya98``Don't Change Credit or I will stop to update``
...
BTW IF YOU INDEED THEN DM @theaditya98
